...
object BrushLibrary {
    val brushes = listOf(
        ...
        BrushType("half tone star",R.drawable.halftonestart,Color.BLACK,100f,Paint.Cap.ROUND,textureRes = R.drawable.halftonestart,category = "halftone"),
        BrushType("half tone hexagon",R.drawable.halftonehexagon,Color.BLACK,100f,Paint.Cap.ROUND,textureRes = R.drawable.halftonehexagon,category = "halftone"),
        BrushType("crosshatch",R.drawable.cross,Color.BLACK,100f,Paint.Cap.ROUND,textureRes = R.drawable.cross,category = "halftone"),
        BrushType(" Half tone dot inv 1",R.drawable.dot1,Color.BLACK,100f,Paint.Cap.ROUND,textureRes = R.drawable.dot1,category = "halftone"),
        BrushType("half tone dot inv 2 ",R.drawable.dot2,Color.BLACK,15f,Paint.Cap.ROUND,textureRes = R.drawable.dot2,category = "halftone"),
        BrushType("half tone dot 1",R.drawable.dotpat1,Color.BLACK,100f,Paint.Cap.ROUND,textureRes = R.drawable.dotpat1,category = "halftone"),
        BrushType("half tone dot 2",R.drawable.dotpat2,Color.BLACK,100f,Paint.Cap.ROUND,textureRes = R.drawable.dotpat2,category = "halftone"),
        BrushType("half tone dot 3",R.drawable.dotpat3,Color.BLACK,100f,Paint.Cap.ROUND,textureRes = R.drawable.dotpat3,category = "halftone"),
